...
const player1 = new Character_1.default('Guerreiro Mortal');
exports.player1 = player1;
const player2 = new Character_1.default('Guerreiro Semi-imortal');
exports.player2 = player2;
const player3 = new Character_1.default('Guerreiro Imortal');
